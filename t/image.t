...
is($wc->html2wiki('<img src="http://hoge/foo.jpeg" height="100" width="200" />'), '&ref(http://hoge/foo.jpeg,200,100)', 'img - width,height');
is($wc->html2wiki('<img src="http://hoge/foo.jpeg" height="100" />'), '&ref(http://hoge/foo.jpeg,,100)', 'img - only height');
is($wc->html2wiki('<img src="http://hoge/foo.jpeg" align="left" />'), '&ref(http://hoge/foo.jpeg,left)', 'img - align');
is($wc->html2wiki('<img src="http://hoge/foo.jpeg" height="100" width="200" align="left" />'), '&ref(http://hoge/foo.jpeg,200,100,left)', 'img - all attr');
